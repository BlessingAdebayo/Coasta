                ...
                <Box  height="500px" p={7}>
                  <HStack spacing="10px" >
                    <Box fontSize="33px" fontFamily=" Papyrus" fontWeight="bold" bgClip='text' width={950} bgGradient='linear(to-r,cyan.100, blue.100)' ml={10} >
                                    Coasta users can subscribe to one of the three subscription plans (Essential, Moderate, and Delux). They can subscribe by minting TOKEN by paying some $CT tokens.
                    </Box>
                    <Flex >
                ...
                <Box height="500px" p={7}>
                  <HStack spacing="10px" >
                    ...
                    <Box  fontSize="33px" fontFamily=" Papyrus" fontWeight="bold" bgClip='text' width={1200} bgGradient='linear(to-r,cyan.100, blue.100)'>
                                    <Text ml={200}>
                                      There are some privilages for delux users. They can create occurrences in three market class (Lifestyle, Matches, and Social) and vote up to 20 vote on different occurrences. 
                                    </Text>
                    </Box>
                  </HStack>
                ...
                <Box  height="600px" p={7}>
                  <HStack spacing="10px" >
                    ...
                    <Box fontSize="33px" fontFamily=" Papyrus" fontWeight="bold" bgClip='text' width={1170} bgGradient='linear(to-r,cyan.100, blue.100)' ml={10} >
                     <Text ml={200} >
                       Coasta users can earn different amount of Coasta tokens ($CT) when they vote correctly on differnet occurrences. Essential users can earn 10 $CT, while intermediate users can earn 20 $CT. On the other hand, Delux users earn 30 $CT tokens.
                      </Text>
                    </Box>
